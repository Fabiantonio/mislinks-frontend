      ...
      <main className="mx-auto max-w-5xl px-5 lg:px-0 pt-20 pb-32">
        <div className="flex flex-col items-center text-center animate-fade-in">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border border-slate-200 mb-8">
            ...
            <span className="text-[10px] font-black text-slate-600 uppercase tracking-wider">simple y seguro</span>
          </div>

          {/* Hero Content */}
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 leading-[1.05] tracking-tight max-w-3xl">
            Todos tus enlaces en <span className="text-slate-500">un solo lugar.</span>
          </h1>
          
          <p className="text-lg md:text-xl text-slate-600 mb-12 leading-relaxed font-medium max-w-2xl">
            Crea tu página personalizada de enlaces en segundos. Comparte tu perfil con el mundo de forma elegante y profesional.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 w-full text-left">
            <div className="p-8 rounded-3xl border border-slate-100 bg-slate-50/50">
              ...
              <h3 className="text-sm font-black text-slate-900 uppercase tracking-wider mb-2">Rápido</h3>
              <p className="text-sm text-slate-600 leading-relaxed font-medium">Configura tu perfil en menos de 2 minutos sin complicaciones.</p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-slate-100 bg-slate-50/50">
              ...
              <h3 className="text-sm font-black text-slate-900 uppercase tracking-wider mb-2">Seguro</h3>
              <p className="text-sm text-slate-600 leading-relaxed font-medium">Tus datos y enlaces están protegidos con tecnología moderna.</p>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-slate-100 bg-slate-50/50">
              ...
              <h3 className="text-sm font-black text-slate-900 uppercase tracking-wider mb-2">Responsivo</h3>
              <p className="text-sm text-slate-600 leading-relaxed font-medium">Tu perfil se verá increíble en cualquier dispositivo móvil o PC.</p>
            </div>
          </div>
        </div>
      </main>
